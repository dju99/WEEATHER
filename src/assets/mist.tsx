...
export default function Mist() {
  return (
    ...
    */
    ...
    .am-weather-fog-1 {
      animation: am-weather-fog-1 8s linear infinite;
    }
    ...
    .am-weather-fog-2 {
      animation: am-weather-fog-2 20s linear infinite;
    }
    ...
    .am-weather-fog-3 {
      animation: am-weather-fog-3 6s linear infinite;
    }
    ...
    .am-weather-fog-4 {
      animation: am-weather-fog-4 6s linear infinite;
    }
          `}
        </style>
      </defs>
